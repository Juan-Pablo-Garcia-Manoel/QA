...
import java.net.URL;
public class TesteCadastroTarefaTest {
  ...
  @Test
  public void testeCadastroTarefa() {
    ...
    driver.findElement(By.id("cpNome")).sendKeys("Selenium");
    driver.findElement(By.id("cpData")).click();
    driver.findElement(By.id("cpData")).click();
    driver.findElement(By.id("cpData")).click();
    driver.findElement(By.id("cpData")).sendKeys("2023-10-15");
